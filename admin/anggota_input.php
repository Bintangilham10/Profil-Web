...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "anggota_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update anggota set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into anggota(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Anggota</h1>
<div class="mb-3 row">
    <a href="anggota.php">
        << Kembali ke halaman admin Anggota</a>
</div>
<?php
if ($error) {
?>
